...
describe('wiredep', function () {
  ...
  describe('events', function() {
    ...
    it('should throw an error when component is not found', function() {
      ...
      }, missingComponent + ' is not installed. Try running `bower install` or remove the component from your package.json file.');
    });
    ...
    it('should allow overriding the error when component is not found', function(done) {
      ...
      wiredep({
        ...
        onError: function(err) {
          ...
          assert.equal(err.message, missingComponent + ' is not installed. Try running `bower install` or remove the component from your package.json file.');
          done();
        }
      });
    });
  ...
  it('should respect the directory specified in a `.bowerrc`', function () {
    ...
    wiredep({
      bowerJson: JSON.parse(fs.readFileSync('./bowerrc/package.json')),
      cwd: './bowerrc',
      src: [filePaths.actual]
    });
  ...
  it('should support inclusion of main files from some other dir with manually loaded package.json', function () {
    ...
    wiredep({
      bowerJson: JSON.parse(fs.readFileSync('./cwd_includeself/package.json')),
      src: [filePaths.actual],
      cwd: 'cwd_includeself',
      includeSelf: true
    });
  ...
  it('include-self: true should support inclusion of glob main files from own package.json', function () {
